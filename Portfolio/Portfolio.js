...
let typingEffect = new Typed(".typedText", {
    strings: ["REACT JS", "Developer", "NARESH"],
    loop: true,
    typeSpeed: 100,
    backSpeed: 80,
    backDelay: 2000
...
document.getElementById('downloadBtn').addEventListener('click', function () {
    const url = 'https://raw.githubusercontent.com/NareshTanuri/My-Resume-/main/MyResume.pdf';
    ...
    fetch(url)
        ...
        .then(blob => {
            ...
            link.setAttribute('download', 'Naresh.pdf');
